...
# Streamlit UI
# ----------------------------
st.title("🧙 Magic: The Gathering – Commander Deckbuilder v0.6")

commander = st.text_input("Commander Name eingeben:", "Omnath, Locus of Rage")
uploaded = st.file_uploader("Moxfield Collection (Text) hochladen")
